        ...
        <div class="col-md-6">
          ...
          @if (Route::has('login'))
              <div class="top-right links">
                  @auth
                      <a href="{{ url('/home') }}" class="btn btn-info btn-raised btn-lg">ESCRITORIO</a>
                  @else
                      <a href="{{ route('login') }}" class="btn btn-danger btn-raised btn-lg"><b>INGRESAR</b></a>
                  @endauth
              </div>
          @endif
        </div>
